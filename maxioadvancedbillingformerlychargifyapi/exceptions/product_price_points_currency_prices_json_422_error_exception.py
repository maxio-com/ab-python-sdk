...
class ProductPricePointsCurrencyPricesJson422ErrorException(maxioadvancedbillingformerlychargifyapi.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ProductPricePointsCurrencyPricesJson422ErrorException class
        ...
        """
        super(ProductPricePointsCurrencyPricesJson422ErrorException, self).__init__(reason, response)
