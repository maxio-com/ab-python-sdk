...
from maxioadvancedbillingformerlychargifyapi.models.customer_error import CustomerError


class CustomersJson422ErrorException(maxioadvancedbillingformerlychargifyapi.exceptions.api_exception.APIException):
