...
from maxioadvancedbillingformerlychargifyapi.models.create_invoice_payment_application import CreateInvoicePaymentApplication
...
class CreateMultiInvoicePayment(object):
    ...
    Attributes:
        ...
        details (str): Additional information related to the payment method
            (eg. Check #).
        method (InvoicePaymentMethodTypeEnum): The type of payment method
            used.
