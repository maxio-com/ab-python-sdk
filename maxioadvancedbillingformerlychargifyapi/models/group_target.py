...
from maxioadvancedbillingformerlychargifyapi.models.group_target_type_enum import GroupTargetTypeEnum
...
class GroupTarget(object):
    ...
    Attributes:
        mtype (GroupTargetTypeEnum): The type of object indicated by the id
            attribute.
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.mtype, type_callable=lambda value: GroupTargetTypeEnum.validate(value))

        if not isinstance(dictionary, dict):
            return False

        return APIHelper.is_valid_type(value=dictionary.get('type'), type_callable=lambda value: GroupTargetTypeEnum.validate(value))
