...
class CreateUsage(object):
    ...
    Attributes:
        quantity (int | float | None): integer by default or decimal number if
            fractional quantities are enabled for the component
    ...
    def from_dictionary(cls,
        ...
        quantity = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CreateUsageQuantity'), dictionary.get('quantity'), False) if dictionary.get('quantity') is not None else APIHelper.SKIP
