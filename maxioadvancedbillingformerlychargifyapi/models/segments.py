...
from maxioadvancedbillingformerlychargifyapi.models.x import X


class Segments(object):

    """Implementation of the 'Segments' model.

    TODO: type model description here.

    Attributes:
        x (X): An attribute 'x' would be changed for a number (an index in
    ...
    def __init__(self,
                 x=APIHelper.SKIP):
        """Constructor for the Segments class"""
    ...
    def from_dictionary(cls,
        ...
        x = X.from_dictionary(dictionary.get('\'x\'')) if '\'x\'' in dictionary.keys() else APIHelper.SKIP
