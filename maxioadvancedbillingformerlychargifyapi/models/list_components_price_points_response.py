...
class ListComponentsPricePointsResponse(object):
    ...
    Attributes:
        price_points (List[ComponentPricePointResponse]): TODO: type
            description here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('price_points') is not None:
            price_points = [ComponentPricePointResponse.from_dictionary(x) for x in dictionary.get('price_points')]
