...
from maxioadvancedbillingformerlychargifyapi.models.invoice_credit import InvoiceCredit
from maxioadvancedbillingformerlychargifyapi.models.invoice_custom_field import InvoiceCustomField
from maxioadvancedbillingformerlychargifyapi.models.invoice_customer import InvoiceCustomer
from maxioadvancedbillingformerlychargifyapi.models.invoice_discount import InvoiceDiscount
from maxioadvancedbillingformerlychargifyapi.models.invoice_line_item import InvoiceLineItem
from maxioadvancedbillingformerlychargifyapi.models.invoice_payment import InvoicePayment
from maxioadvancedbillingformerlychargifyapi.models.invoice_previous_balance import InvoicePreviousBalance
from maxioadvancedbillingformerlychargifyapi.models.invoice_refund import InvoiceRefund
from maxioadvancedbillingformerlychargifyapi.models.invoice_seller import InvoiceSeller
from maxioadvancedbillingformerlychargifyapi.models.invoice_tax import InvoiceTax
...
class Invoice(object):
    ...
    Attributes:
        ...
        paid_date (str): Date the invoice became fully paid.  If partial
            ...
            `"YYYY-MM-DD"`.
        status (StatusEnum): The current status of the invoice. See [Invoice
        ...
        consolidation_level (InvoiceConsolidationLevelEnum): Consolidation
            level of the invoice, which is applicable to invoice
            consolidation.  It will hold one of the following values:  *
            "none": A normal invoice with no consolidation. * "child": An
            invoice segment which has been combined into a consolidated
            invoice. * "parent": A consolidated invoice, whose contents are
            composed of invoice segments.  "Parent" invoices do not have lines
            of their own, but they have subtotals and totals which aggregate
