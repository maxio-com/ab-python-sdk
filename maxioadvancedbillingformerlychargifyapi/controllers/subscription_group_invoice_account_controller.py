...
from maxioadvancedbillingformerlychargifyapi.models.subscription_group_prepayment_response import SubscriptionGroupPrepaymentResponse
from maxioadvancedbillingformerlychargifyapi.models.list_subscription_group_prepayment_response import ListSubscriptionGroupPrepaymentResponse
from maxioadvancedbillingformerlychargifyapi.models.service_credit_response import ServiceCreditResponse
...
class SubscriptionGroupInvoiceAccountController(BaseController):
    ...
    def list_prepayments_for_subscription_group(self,
        ...
        Args:
            uid (str): The uid of the subscription group
            filter_date_field (ListSubscriptionGroupPrepaymentDateFieldEnum,
