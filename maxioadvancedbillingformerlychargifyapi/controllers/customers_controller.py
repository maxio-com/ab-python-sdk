...
from maxioadvancedbillingformerlychargifyapi.exceptions.customers_json_422_error_exception import CustomersJson422ErrorException
...
class CustomersController(BaseController):
    ...
    def list_customers(self,
        ...
        Args:
            direction (SortingDirectionEnum | None, optional): Direction to
