...
from maxioadvancedbillingformerlychargifyapi.models.prepaid_configuration_response import PrepaidConfigurationResponse
from maxioadvancedbillingformerlychargifyapi.models.subscription_preview_response import SubscriptionPreviewResponse
...
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_add_coupon_json_422_error_exception import SubscriptionsAddCouponJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_remove_coupon_json_422_error_exception import SubscriptionsRemoveCouponJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_activate_json_400_error_exception import SubscriptionsActivateJson400ErrorException
...
class SubscriptionsController(BaseController):
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    per_page -- int -- This parameter indicates how many
                        ...
                        `per_page=200`.
                    state -- SubscriptionStateEnum -- The current state of the
                        subscription
                    ...
                    coupon -- int -- The numeric id of the coupon currently
                        ...
                        cannot be used.)
                    date_field -- SubscriptionDateFieldEnum -- The type of
                        filter you'd like to apply to your search.  Allowed
                    ...
                    metadata -- Dict[str, str] -- The value of the metadata
                        ...
                        _value`.
                    direction -- SortingDirectionEnum | None -- Controls the
                        order in which results are returned. Use in query
                        `direction=asc`.
                    sort -- SubscriptionSortEnum -- The attribute by which to
                        sort
    ...
    def read_subscription(self,
        ...
        Args:
            subscription_id (str): The Chargify id of the subscription
            include (List[SubscriptionIncludeEnum], optional): Allows
    ...
    def read_subscription_by_reference(self,
        ...
        Args:
            reference (str, optional): TODO: type description here.
    ...
    def purge_subscription(self,
        ...
        Args:
            subscription_id (str): The Chargify id of the subscription
            ack (int, optional): id of the customer.
            cascade (List[SubscriptionPurgeTypeEnum], optional): Options are
    ...
    def apply_coupon_to_subscription(self,
        ...
        Args:
            subscription_id (str): The Chargify id of the subscription
            code (str, optional): TODO: type description here.
    ...
    def delete_coupon_from_subscription(self,
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsRemoveCouponJson422ErrorException)
        ).execute()
    ...
    def activate_subscription(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(SubscriptionResponse.from_dictionary)
            .local_error('400', 'Bad Request', SubscriptionsActivateJson400ErrorException)
        ).execute()
