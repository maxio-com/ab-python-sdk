...
from maxioadvancedbillingformerlychargifyapi.models.coupon_response import CouponResponse
from maxioadvancedbillingformerlychargifyapi.models.coupon import Coupon
from maxioadvancedbillingformerlychargifyapi.models.coupon_usage import CouponUsage
from maxioadvancedbillingformerlychargifyapi.models.coupon_currency import CouponCurrency
from maxioadvancedbillingformerlychargifyapi.models.coupon_subcodes_response import CouponSubcodesResponse
from maxioadvancedbillingformerlychargifyapi.models.coupon_subcodes import CouponSubcodes
from maxioadvancedbillingformerlychargifyapi.exceptions.error_list_response_exception import ErrorListResponseException
from maxioadvancedbillingformerlychargifyapi.exceptions.coupons_validate_json_404_error_exception import CouponsValidateJson404ErrorException
...
class CouponsController(BaseController):
    ...
    def list_coupons_for_product_family(self,
        ...
        Returns:
            List[Coupon]: Response from the API. OK
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(Coupon.from_dictionary)
        ).execute()
    ...
    def list_coupons(self,
        ...
        Args:
            ...
            per_page (int, optional): This parameter indicates how many
                ...
                maximum allowed values is 200; any per_page value over 200
                will be changed to 200. Use in query `per_page=200`.
            date_field (BasicDateFieldEnum, optional): The field was
                deprecated: on January 20, 2022. We recommend using
                filter[date_field] instead to achieve the same result. The
                type of filter you would like to apply to your search.
    ...
    def validate_coupon(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(CouponResponse.from_dictionary)
            .local_error('404', 'Not Found', CouponsValidateJson404ErrorException)
        ).execute()
    ...
    def delete_coupon_subcode(self,
        ...
        Args:
            coupon_id (int): The Chargify id of the coupon to which the
                subcode belongs
            subcode (str): TODO: type description here.
