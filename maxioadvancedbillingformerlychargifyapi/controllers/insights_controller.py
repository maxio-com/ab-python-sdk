...
from maxioadvancedbillingformerlychargifyapi.models.site_summary import SiteSummary
from maxioadvancedbillingformerlychargifyapi.models.mrr_response import MRRResponse
from maxioadvancedbillingformerlychargifyapi.models.list_mrr_response import ListMRRResponse
from maxioadvancedbillingformerlychargifyapi.models.subscription_mrr_response import SubscriptionMRRResponse
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_mrr_json_400_error_exception import SubscriptionsMrrJson400ErrorException
...
class InsightsController(BaseController):
    ...
    def list_mrr_per_subscription(self,
        ...
        Args:
            ...
            direction (DirectionEnum, optional): Controls the order in which
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Bad Request', SubscriptionsMrrJson400ErrorException)
        ).execute()
