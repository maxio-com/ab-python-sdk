...
from maxioadvancedbillingformerlychargifyapi.models.subscription_group_signup_response import SubscriptionGroupSignupResponse
from maxioadvancedbillingformerlychargifyapi.models.subscription_group_response import SubscriptionGroupResponse
from maxioadvancedbillingformerlychargifyapi.models.list_subscription_groups_response import ListSubscriptionGroupsResponse
from maxioadvancedbillingformerlychargifyapi.models.full_subscription_group_response import FullSubscriptionGroupResponse
from maxioadvancedbillingformerlychargifyapi.models.delete_subscription_group_response import DeleteSubscriptionGroupResponse
from maxioadvancedbillingformerlychargifyapi.exceptions.subscription_groups_signup_json_422_error_exception import SubscriptionGroupsSignupJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscription_groups_json_422_error_exception import SubscriptionGroupsJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscription_groups_json_422_error_2_exception import SubscriptionGroupsJson422Error2Exception
...
class SubscriptionGroupsController(BaseController):
    ...
    def signup_with_subscription_group(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionGroupsSignupJson422ErrorException)
        ).execute()
    ...
    def create_subscription_group(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionGroupsJson422ErrorException)
        ).execute()
    ...
    def list_subscription_groups(self,
        ...
        Args:
            ...
            include (str, optional): TODO: type description here.
    ...
    def update_subscription_group_members(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(SubscriptionGroupResponse.from_dictionary)
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionGroupsJson422Error2Exception)
        ).execute()
