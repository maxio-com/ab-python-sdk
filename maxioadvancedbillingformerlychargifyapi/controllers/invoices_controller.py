...
from maxioadvancedbillingformerlychargifyapi.models.list_invoices_response import ListInvoicesResponse
from maxioadvancedbillingformerlychargifyapi.models.list_invoice_events_response import ListInvoiceEventsResponse
from maxioadvancedbillingformerlychargifyapi.models.multi_invoice_payment_response import MultiInvoicePaymentResponse
from maxioadvancedbillingformerlychargifyapi.models.list_credit_notes_response import ListCreditNotesResponse
from maxioadvancedbillingformerlychargifyapi.models.credit_note import CreditNote
from maxioadvancedbillingformerlychargifyapi.models.payment_response import PaymentResponse
from maxioadvancedbillingformerlychargifyapi.models.consolidated_invoice import ConsolidatedInvoice
from maxioadvancedbillingformerlychargifyapi.models.invoice_response import InvoiceResponse
from maxioadvancedbillingformerlychargifyapi.models.customer_changes_preview_response import CustomerChangesPreviewResponse
...
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_invoices_json_422_error_exception import SubscriptionsInvoicesJson422ErrorException
...
class InvoicesController(BaseController):
    ...
    def list_invoices(self,
        ...
        Args:
            ...
            date_field (InvoiceDateFieldEnum, optional): The type of filter
            ...
            end_datetime (str, optional): The end date and time (format
                ...
                updated_at.
            customer_ids (List[object], optional): Allows fetching invoices
                with matching customer id based on provided values. Use in
            ...
            sort (InvoiceSortFieldEnum, optional): Allows specification of the
    ...
    def list_invoice_events(self,
        ...
        Args:
            since_date (str, optional): TODO: type description here.
            ...
            event_types (List[InvoiceEventTypeEnum], optional): Filter results
                by event_type. Supply a comma separated list of event types
    ...
    def list_invoice_segments(self,
        ...
        Args:
            ...
            per_page (int, optional): This parameter indicates how many
                ...
                maximum allowed values is 200; any per_page value over 200
                will be changed to 200. Use in query `per_page=200`.
            direction (DirectionEnum, optional): Sort direction of the
                returned segments.
    ...
    def create_invoice(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsInvoicesJson422ErrorException)
        ).execute()
