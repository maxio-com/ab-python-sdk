...
from maxioadvancedbillingformerlychargifyapi.models.delayed_cancellation_response import DelayedCancellationResponse
from maxioadvancedbillingformerlychargifyapi.models.renewal_preview_response import RenewalPreviewResponse
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_retry_json_422_error_exception import SubscriptionsRetryJson422ErrorException
...
class SubscriptionStatusController(BaseController):
    ...
    def retry_subscription(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsRetryJson422ErrorException)
        ).execute()
    ...
    def resume_subscription(self,
        ...
        Args:
            subscription_id (str): The Chargify id of the subscription
            calendar_billing_resumption_charge (ResumptionChargeEnum,
                optional): (For calendar billing subscriptions only) The way
                that the resumed subscription's charge should be handled
    ...
    def reactivate_subscription(self,
        ...
        **Please note: The term
        ...
        #### Results
        + The subscription will transition to active
        ### Reactivating a trial ended subscription, without the include_trial
        flag
        + Given you have a trial_ended subscription
        + The product associated with the subscription has a trial
        + Send a PUT request to
