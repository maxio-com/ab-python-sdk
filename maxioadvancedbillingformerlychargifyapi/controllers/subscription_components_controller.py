...
from maxioadvancedbillingformerlychargifyapi.models.subscription_component_response import SubscriptionComponentResponse
from maxioadvancedbillingformerlychargifyapi.models.bulk_component_s_price_point_assignment import BulkComponentSPricePointAssignment
from maxioadvancedbillingformerlychargifyapi.models.subscription_response import SubscriptionResponse
from maxioadvancedbillingformerlychargifyapi.models.allocation_response import AllocationResponse
from maxioadvancedbillingformerlychargifyapi.models.allocation_preview_response import AllocationPreviewResponse
from maxioadvancedbillingformerlychargifyapi.models.usage_response import UsageResponse
from maxioadvancedbillingformerlychargifyapi.models.list_subscription_components_response import ListSubscriptionComponentsResponse
from maxioadvancedbillingformerlychargifyapi.exceptions.api_exception import APIException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_price_points_json_422_error_exception import SubscriptionsPricePointsJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.error_list_response_exception import ErrorListResponseException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_allocations_preview_json_422_error_exception import SubscriptionsAllocationsPreviewJson422ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_components_allocations_allocation_id_json_422_error_exception import SubscriptionsComponentsAllocationsAllocationIdJson422ErrorException
...
class SubscriptionComponentsController(BaseController):
    ...
    def list_subscription_components(self,
        ...
        Args:
            subscription_id (str): The Chargify id of the subscription
            date_field (ListSubscriptionComponentsDateFieldEnum, optional):
                The type of filter you'd like to apply to your search. Use in
            ...
            price_point_ids (IncludeNotNullEnum, optional): Allows fetching
            ...
            sort (ListSubscriptionComponentsSortEnum, optional): The attribute
                by which to sort. Use in query `sort=updated_at`.
            ...
            include (ListSubscriptionComponentsIncludeEnum, optional): Allows
    ...
    def update_subscription_components_price_points(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsPricePointsJson422ErrorException)
        ).execute()
    ...
    def preview_allocations(self,
        ...
        **quantity-based** or **on/off** component allocation in the middle of
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsAllocationsPreviewJson422ErrorException)
        ).execute()
    ...
    def record_events(self,
        ...
        *Note: this endpoint differs from the standard Chargify endpoints in
        ...
        Args:
            ...
            api_handle (str): TODO: type description here.
            store_uid (str, optional): If you've attached your own Keen
                project as a Chargify event data-store, use this parameter to
                indicate the data-store.
    ...
    def list_subscription_components_for_site(self,
        ...
        Args:
            ...
            filter_subscription_states (List[SubscriptionStateEnum],
                optional): Allows fetching components allocations that belong
                to the subscription with matching states based on provided
                values. To use this filter you also have to include the
                following param in the request `include=subscription`. Use in
                query
            ...
            filter_subscription_date_field
                ...
                optional): The type of filter you'd like to apply to your
                search. To use this filter you also have to include the
