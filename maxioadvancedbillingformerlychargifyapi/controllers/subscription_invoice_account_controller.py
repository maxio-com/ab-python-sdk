...
from maxioadvancedbillingformerlychargifyapi.models.account_balances import AccountBalances
from maxioadvancedbillingformerlychargifyapi.models.create_prepayment_response import CreatePrepaymentResponse
from maxioadvancedbillingformerlychargifyapi.models.subscriptions_prepayments_json_response import SubscriptionsPrepaymentsJsonResponse
...
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_prepayments_refunds_json_400_error_exception import SubscriptionsPrepaymentsRefundsJson400ErrorException
from maxioadvancedbillingformerlychargifyapi.exceptions.subscriptions_prepayments_refunds_json_422_error_exception import SubscriptionsPrepaymentsRefundsJson422ErrorException
...
class SubscriptionInvoiceAccountController(BaseController):
    ...
    def list_prepayments(self,
        ...
        Args:
            ...
            filter_date_field (BasicDateFieldEnum, optional): The type of
                filter you would like to apply to your search. created_at -
        ...
        Returns:
            SubscriptionsPrepaymentsJsonResponse: Response from the API. OK
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(SubscriptionsPrepaymentsJsonResponse.from_dictionary)
    ...
    def refund_prepayment(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Bad Request', SubscriptionsPrepaymentsRefundsJson400ErrorException)
            .local_error('404', 'Not Found', APIException)
            .local_error('422', 'Unprocessable Entity (WebDAV)', SubscriptionsPrepaymentsRefundsJson422ErrorException)
        ).execute()
