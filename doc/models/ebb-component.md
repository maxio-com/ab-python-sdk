...
|  --- | --- | --- | --- |
| `name` | `str` | Required | A name for this component that is suitable for showing customers and displaying on billing statements, i.e., "Minutes". |
...
ebb_component = EBBComponent(
    name='name0',
    unit_name='unit_name2',
    pricing_scheme=PricingScheme.PER_UNIT,
    event_based_billing_metric_id=250,
