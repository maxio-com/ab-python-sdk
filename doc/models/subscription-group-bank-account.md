...
subscription_group_bank_account = SubscriptionGroupBankAccount(
    bank_name='bank_name4',
    bank_account_number='bank_account_number2',
    bank_routing_number='bank_routing_number6',
    bank_iban='bank_iban8',
    bank_branch_code='bank_branch_code4'
)
```
