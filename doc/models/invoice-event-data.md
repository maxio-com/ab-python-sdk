...
| `role` | [`InvoiceRole1`](../../doc/models/invoice-role-1.md) | Optional | The role of the credit note (e.g. 'general') |
...
| `from_status` | `object` | Optional | - |
| `to_status` | `object` | Optional | - |
...
| `line_items` | [`List[InvoiceLineItem1]`](../../doc/models/invoice-line-item-1.md) | Optional | Line items on the invoice. |
