...
|  --- | --- | --- | --- |
| `subscription_group` | [`SubscriptionGroupSignup`](../../doc/models/subscription-group-signup.md) | Required | - |
...
subscription_group_signup_request = SubscriptionGroupSignupRequest(
