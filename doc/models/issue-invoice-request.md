...
```python
from advancedbilling.models.failed_payment_action import FailedPaymentAction
from advancedbilling.models.issue_invoice_request import IssueInvoiceRequest

issue_invoice_request = IssueInvoiceRequest(
