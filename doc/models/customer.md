...
| `cc_emails` | `str` | Optional | “A comma-separated list of emails that should be cc’d on all customer communications (e.g., “joe@example.com, sue@example.com”)” |
...
| `address` | `str` | Optional | The customer’s shipping street address (e.g., “123 Main St.”) |
| `address_2` | `str` | Optional | Second line of the customer’s shipping address e.g., “Apt. 100” |
...
| `zip` | `str` | Optional | The customer’s shipping address zip code (e.g., “12345”) |
