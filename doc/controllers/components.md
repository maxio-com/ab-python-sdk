...
body = CreateMeteredComponent(
    metered_component=MeteredComponent(
        ...
        pricing_scheme=PricingSchemeEnum.STAIRSTEP,
        taxable=False,
        prices=[
...
body = UpdateComponentRequest(
    component=UpdateComponent(
        item_category=ItemCategoryEnum.ENUM_BUSINESS_SOFTWARE
    )
)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `component_id` | `str` | Template, Required | - |
...
| `filter_type` | [`List[PricePointTypeEnum]`](../../doc/models/price-point-type-enum.md) | Query, Optional | Allows fetching price points with matching type. Use in query: `filter[type]=custom,catalog`. |
