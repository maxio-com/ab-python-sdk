...
|  --- | --- | --- |
| 422 | Unprocessable Entity (WebDAV) | [`SubscriptionsRetryJson422ErrorException`](../../doc/models/subscriptions-retry-json-422-error-exception.md) |
...
|  --- | --- | --- | --- |
| `subscription_id` | `str` | Template, Required | The Chargify id of the subscription |
| `calendar_billing_resumption_charge` | [`ResumptionChargeEnum`](../../doc/models/resumption-charge-enum.md) | Query, Optional | (For calendar billing subscriptions only) The way that the resumed subscription's charge should be handled<br>**Default**: `'prorated'` |
...
|  --- | --- | --- | --- |
| `subscription_id` | `str` | Template, Required | The Chargify id of the subscription |
| `body` | [`PauseRequest`](../../doc/models/pause-request.md) | Body, Optional | - |
...
body = ReactivateSubscriptionRequest(
    calendar_billing=ReactivationBilling(
        reactivation_charge=ReactivationChargeEnum.PRORATED
    ),
    include_trial=True,
