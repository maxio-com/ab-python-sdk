...
|  --- | --- | --- | --- |
| `uid` | `str` | Template, Required | The uid of the subscription group |
| `filter_date_field` | [`ListSubscriptionGroupPrepaymentDateFieldEnum`](../../doc/models/list-subscription-group-prepayment-date-field-enum.md) | Query, Optional | The type of filter you would like to apply to your search.<br>Use in query: `filter[date_field]=created_at`. |
