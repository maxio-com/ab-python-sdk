...
from advancedbilling.models.customer_credit_note import CustomerCreditNote
...
class CreditNoteInvoiceEvent(object):

    """Implementation of the 'Credit Note_Invoice Event' model.
    ...
    Attributes:
        ...
        customer (CustomerCreditNote): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the CreditNoteInvoiceEvent class"""
    ...
    def from_dictionary(cls,
        ...
        customer = CustomerCreditNote.from_dictionary(dictionary.get('customer')) if 'customer' in dictionary.keys() else APIHelper.SKIP
