...
class PricePointIdCreateAllocation(object):

    """Implementation of the 'PricePointId_Create Allocation' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PricePointIdCreateAllocation class"""
