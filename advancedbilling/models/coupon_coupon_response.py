...
class CouponCouponResponse(object):

    """Implementation of the 'Coupon_Coupon Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CouponCouponResponse class"""
    ...
    def from_dictionary(cls,
        ...
        compounding_strategy = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CouponCouponResponseCompoundingStrategy'), dictionary.get('compounding_strategy'), False) if dictionary.get('compounding_strategy') is not None else APIHelper.SKIP
