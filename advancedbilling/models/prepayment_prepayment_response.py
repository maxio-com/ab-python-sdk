...
class PrepaymentPrepaymentResponse(object):

    """Implementation of the 'Prepayment_Prepayment Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PrepaymentPrepaymentResponse class"""
