...
class MetafieldsUpdateMetafieldsRequest(object):

    """Implementation of the 'Metafields_Update Metafields Request' model.
    ...
    def __init__(self,
                 ...
                 input_type='text',
                 enum=APIHelper.SKIP):
        """Constructor for the MetafieldsUpdateMetafieldsRequest class"""
