...
class PrepaymentPrepaymentsResponse(object):

    """Implementation of the 'Prepayment_Prepayments Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PrepaymentPrepaymentsResponse class"""
