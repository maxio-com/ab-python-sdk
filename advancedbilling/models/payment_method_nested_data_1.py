...
class PaymentMethodNestedData1(object):

    """Implementation of the 'Payment Method Nested Data1' model.
    ...
    def __init__(self,
                 ...
                 memo=None,
                 email=None,
                 mtype='Payment Method Nested Data1',
                 card_expiration=APIHelper.SKIP,
                 last_four=APIHelper.SKIP):
        """Constructor for the PaymentMethodNestedData1 class"""
    ...
    def from_dictionary(cls,
        ...
        mtype = dictionary.get("type") if dictionary.get("type") else 'Payment Method Nested Data1'
