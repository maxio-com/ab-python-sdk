...
class UnitPricePrepaidUsageComponent(object):

    """Implementation of the 'UnitPrice_Prepaid Usage Component' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UnitPricePrepaidUsageComponent class"""
