...
class PaymentMethodNestedDataInvoiceEvent(object):

    """Implementation of the 'Payment Method Nested Data_Invoice Event' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PaymentMethodNestedDataInvoiceEvent class"""
