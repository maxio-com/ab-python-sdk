...
from advancedbilling.models.credit_note_invoice_event import CreditNoteInvoiceEvent


class InvoiceEventInvoiceEvent(object):

    """Implementation of the 'Invoice Event_Invoice Event' model.
    ...
    Attributes:
        ...
        apply_credit (bool): If true, credit was created and applied it to the
            invoice.
        credit_note_attributes (CreditNoteInvoiceEvent): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the InvoiceEventInvoiceEvent class"""
    ...
    def from_dictionary(cls,
        ...
        payment_method = APIHelper.deserialize_union_type(UnionTypeLookUp.get('InvoiceEventInvoiceEventPaymentMethod'), dictionary.get('payment_method'), False) if dictionary.get('payment_method') is not None else APIHelper.SKIP
        ...
        credit_note_attributes = CreditNoteInvoiceEvent.from_dictionary(dictionary.get('credit_note_attributes')) if 'credit_note_attributes' in dictionary.keys() else APIHelper.SKIP
