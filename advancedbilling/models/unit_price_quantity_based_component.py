...
class UnitPriceQuantityBasedComponent(object):

    """Implementation of the 'UnitPrice_Quantity Based Component' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UnitPriceQuantityBasedComponent class"""
