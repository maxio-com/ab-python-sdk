...
class TestCustomFields(TestBase):
    def test_create_metafield_given_subscription_resource_type_and_dropdown_type_and_not_configured_text_field_then_dropdown_has_enum_with_two_options_and_text_field_is_configured_as_text_input_by_default(
            self):
