...
class SubscriptionsControllerTests(ControllerTestBase):
    ...
    def test_create_subscription(self):
        ...
        body = APIHelper.json_deserialize('{"subscription":{"product_handle":"basic","customer_attributes":{"'
            'first_name":"Joe","last_name":"Blow","email":"joe@example.com","zi'
            'p":"02120","state":"MA","reference":"XYZ","phone":"(617) 111 - 000'
            '0","organization":"Acme","country":"US","city":"Boston","address_2'
            '":null,"address":"123 Mass Ave."},"credit_card_attributes":{"last_'
            'name":"Smith","first_name":"Joe","full_number":"4111111111111111",'
            '"expiration_year":"2021","expiration_month":"1","card_type":"visa"'
            ',"billing_zip":"02120","billing_state":"MA","billing_country":"US"'
            ',"billing_city":"Boston","billing_address_2":null,"billing_address'
            '":"123 Mass Ave."}}}', CreateSubscriptionRequest.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_subscription(body)
        ...
        expected_body = APIHelper.json_deserialize('{"subscription":{"id":15236915,"state":"active","balance_in_cents"'
            ':0,"total_revenue_in_cents":14000,"product_price_in_cents":1000,"p'
            'roduct_version_number":7,"current_period_ends_at":"2016-11-15T14:4'
            '8:10-05:00","next_assessment_at":"2016-11-15T14:48:10-05:00","tria'
            'l_started_at":null,"trial_ended_at":null,"activated_at":"2016-11-1'
            '4T14:48:12-05:00","expires_at":null,"created_at":"2016-11-14T14:48'
            ':10-05:00","updated_at":"2016-11-14T15:24:41-05:00","cancellation_'
            'message":null,"cancellation_method":"merchant_api","cancel_at_end_'
            'of_period":null,"canceled_at":null,"current_period_started_at":"20'
            '16-11-14T14:48:10-05:00","previous_state":"active","signup_payment'
            '_id":162269766,"signup_revenue":"260.00","delayed_cancel_at":null,'
            '"coupon_code":"5SNN6HFK3GBH","payment_collection_method":"automati'
            'c","snap_day":null,"reason_code":null,"receives_invoice_emails":fa'
            'lse,"customer":{"first_name":"Curtis","last_name":"Test","email":"'
            'curtis@example.com","cc_emails":"jeff@example.com","organization":'
            '"","reference":null,"id":14714298,"created_at":"2016-11-14T14:48:1'
            '0-05:00","updated_at":"2016-11-14T14:48:13-05:00","address":"123 A'
            'nywhere Street","address_2":"","city":"Boulder","state":"CO","zip"'
            ':"80302","country":"US","phone":"","verified":false,"portal_custom'
            'er_created_at":"2016-11-14T14:48:13-05:00","portal_invite_last_sen'
            't_at":"2016-11-14T14:48:13-05:00","portal_invite_last_accepted_at"'
            ':null,"tax_exempt":false,"vat_number":"012345678"},"product":{"id"'
            ':3792003,"name":"$10 Basic Plan","handle":"basic","description":"l'
            'orem ipsum","accounting_code":"basic","price_in_cents":1000,"inter'
            'val":1,"interval_unit":"day","initial_charge_in_cents":null,"expir'
            'ation_interval":null,"expiration_interval_unit":"never","trial_pri'
            'ce_in_cents":null,"trial_interval":null,"trial_interval_unit":"mon'
            'th","initial_charge_after_trial":false,"return_params":"","request'
            '_credit_card":false,"require_credit_card":false,"created_at":"2016'
            '-03-24T13:38:39-04:00","updated_at":"2016-11-03T13:03:05-04:00","a'
            'rchived_at":null,"update_return_url":"","update_return_params":"",'
            '"product_family":{"id":527890,"name":"Acme Projects","handle":"bil'
            'ling-plans","accounting_code":null,"description":""},"public_signu'
            'p_pages":[{"id":281054,"url":"https://general-goods.chargify.com/s'
            'ubscribe/kqvmfrbgd89q/basic"},{"id":281240,"url":"https://general-'
            'goods.chargify.com/subscribe/dkffht5dxfd8/basic"},{"id":282694,"ur'
            'l":"https://general-goods.chargify.com/subscribe/jwffwgdd95s8/basi'
            'c"}],"taxable":false,"version_number":7,"product_price_point_name"'
            ':"Default"},"credit_card":{"id":10191713,"payment_type":"credit_ca'
            'rd","first_name":"Curtis","last_name":"Test","masked_card_number":'
            '"XXXX-XXXX-XXXX-1","card_type":"bogus","expiration_month":1,"expir'
            'ation_year":2026,"billing_address":"123 Anywhere Street","billing_'
            'address_2":"","billing_city":"Boulder","billing_state":null,"billi'
            'ng_country":"","billing_zip":"80302","current_vault":"bogus","vaul'
            't_token":"1","customer_vault_token":null,"customer_id":14714298},"'
            'payment_type":"credit_card","referral_code":"w7kjc9","next_product'
            '_id":null,"coupon_use_count":1,"coupon_uses_allowed":1,"next_produ'
            'ct_handle":null,"stored_credential_transaction_id":125566112256688'
            ',"dunning_communication_delay_enabled":true,"dunning_communication'
            '_delay_time_zone":"Eastern Time (US & Canada)"}}')
    ...
    def test_list_subscriptions(self):
        ...
        options['product_price_point_id'] = None
        options['coupon'] = None
        options['date_field'] = None
        options['start_date'] = dateutil.parser.parse('2022-07-01').date()
        options['end_date'] = dateutil.parser.parse('2022-08-01').date()
        options['start_datetime'] = APIHelper.RFC3339DateTime.from_value('2022-07-01 09:00:05').datetime
        options['end_datetime'] = APIHelper.RFC3339DateTime.from_value('2022-08-01 10:00:05').datetime
        options['metadata'] = None
        options['direction'] = None
        options['sort'] = 'signup_date'

        # Perform the API call through the SDK function
        result = self.controller.list_subscriptions(options)
    ...
    def test_read_subscription_by_reference(self):
        # Parameters for the API call
        reference = None

        # Perform the API call through the SDK function
        result = self.controller.read_subscription_by_reference(reference)
    ...
    def test_preview_subscription(self):
        # Parameters for the API call
        body = APIHelper.json_deserialize('{"subscription":{"product_handle":"gold-product"}}', CreateSubscriptionRequest.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.preview_subscription(body)
        ...
        # Test whether the captured response is as we expected
        assert result is not None
        expected_body = APIHelper.json_deserialize('{"subscription_preview":{"current_billing_manifest":{"line_items":'
            '[{"transaction_type":"charge","kind":"baseline","amount_in_cents":'
            '5000,"memo":"Gold Product (08/21/2018 - 09/21/2018)","discount_amo'
            'unt_in_cents":0,"taxable_amount_in_cents":0,"product_id":1,"produc'
            't_handle":"gold-product","product_name":"Gold Product"},{"transact'
            'ion_type":"charge","kind":"component","amount_in_cents":28000,"mem'
            'o":"Component name: 14 Unit names","discount_amount_in_cents":0,"t'
            'axable_amount_in_cents":0,"component_id":462149,"component_handle"'
            ':"handle","component_name":"Component name"},{"transaction_type":"'
            'charge","kind":"component","amount_in_cents":2000,"memo":"Fraction'
            'al Metered Components: 20.0 Fractional Metereds","discount_amount_'
            'in_cents":0,"taxable_amount_in_cents":0,"component_id":426665,"com'
            'ponent_handle":"handle","component_name":"Fractional Metered Compo'
            'nents"},{"transaction_type":"charge","kind":"component","amount_in'
            '_cents":0,"memo":"On/Off Component","discount_amount_in_cents":0,"'
            'taxable_amount_in_cents":0,"component_id":426670,"component_handle'
            '":"handle","component_name":"On/Off Component"},{"transaction_type'
            '":"adjustment","kind":"coupon","amount_in_cents":0,"memo":"Coupon:'
            ' 1DOLLAR - You only get $1.00 off","discount_amount_in_cents":0,"t'
            'axable_amount_in_cents":0}],"total_in_cents":35000,"total_discount'
            '_in_cents":0,"total_tax_in_cents":0,"subtotal_in_cents":35000,"sta'
            'rt_date":"2018-08-21T21:25:21Z","end_date":"2018-09-21T21:25:21Z",'
            '"period_type":"recurring","existing_balance_in_cents":0},"next_bil'
            'ling_manifest":{"line_items":[{"transaction_type":"charge","kind":'
            '"baseline","amount_in_cents":5000,"memo":"Gold Product (09/21/2018'
            ' - 10/21/2018)","discount_amount_in_cents":0,"taxable_amount_in_ce'
            'nts":0,"product_id":1,"product_handle":"gold-product","product_nam'
            'e":"Gold Product"},{"transaction_type":"charge","kind":"component"'
            ',"amount_in_cents":28000,"memo":"Component name: 14 Unit names","d'
            'iscount_amount_in_cents":0,"taxable_amount_in_cents":0,"component_'
            'id":462149,"component_handle":"handle","component_name":"Component'
            ' name"},{"transaction_type":"charge","kind":"component","amount_in'
            '_cents":0,"memo":"On/Off Component","discount_amount_in_cents":0,"'
            'taxable_amount_in_cents":0,"component_id":426670,"component_handle'
            '":"handle","component_name":"On/Off Component"}],"total_in_cents":'
            '33000,"total_discount_in_cents":0,"total_tax_in_cents":0,"subtotal'
            '_in_cents":33000,"start_date":"2018-09-21T21:25:21Z","end_date":"2'
            '018-10-21T21:25:21Z","period_type":"recurring","existing_balance_i'
            'n_cents":0}}}')
        received_body = APIHelper.json_deserialize(self.response_catcher.response.text)
        assert ComparisonHelper.match_body(expected_body, received_body)
